...
.field private g:Lkik/android/widget/bm;
...
# direct methods
.method public constructor <init>(Lkik/android/widget/bm;Landroid/support/v7/widget/RecyclerView;)V
    .locals 5
    ...
    iput v0, p0, Lkik/android/widget/dk;->a:I
    ...
    iput v0, p0, Lkik/android/widget/dk;->d:I

    .line 26
    const/4 v0, 0x3

    iput v0, p0, Lkik/android/widget/dk;->e:I

    .line 27
    const/16 v0, 0x30

    iput v0, p0, Lkik/android/widget/dk;->f:I

    .line 35
    iput-object p1, p0, Lkik/android/widget/dk;->g:Lkik/android/widget/bm;
    ...
    iput-object v0, p0, Lkik/android/widget/dk;->i:Landroid/view/View;

    .line 40
    iget-object v0, p0, Lkik/android/widget/dk;->i:Landroid/view/View;

    new-instance v1, Landroid/view/ViewGroup$LayoutParams;

    iget v2, p0, Lkik/android/widget/dk;->a:I
    ...
    iput-object v0, p0, Lkik/android/widget/dk;->j:Landroid/view/View;

    .line 44
    iget-object v0, p0, Lkik/android/widget/dk;->j:Landroid/view/View;
    ...
    iget-object v1, p0, Lkik/android/widget/dk;->i:Landroid/view/View;
    ...
    iget-object v1, p0, Lkik/android/widget/dk;->j:Landroid/view/View;
...
.method public final a(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    .line 56
    invoke-interface {p1}, Lkik/android/widget/bl;->a()Z
    ...
    :goto_0
    invoke-static {v0}, Lkik/android/widget/dk;->a(I)I
...
.method public final a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;FFIZ)V
    ...
    .line 83
    iget-object v0, p0, Lkik/android/widget/dk;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 102
    iput-object p3, p0, Lkik/android/widget/dk;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    .line 103
    iget-object v1, p0, Lkik/android/widget/dk;->g:Lkik/android/widget/bm;

    invoke-interface {v1, v0}, Lkik/android/widget/bm;->h(I)V
    ...
    iget v1, p0, Lkik/android/widget/dk;->b:I

    sub-int/2addr v0, v1

    .line 113
    iget-object v1, p0, Lkik/android/widget/dk;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget-object v2, p0, Lkik/android/widget/dk;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget v2, p0, Lkik/android/widget/dk;->c:I

    add-int/2addr v1, v2

    .line 114
    iget-object v2, p0, Lkik/android/widget/dk;->i:Landroid/view/View;
    ...
    invoke-interface {v1, v0}, Lkik/android/widget/bm;->i(I)V

    .line 131
    const/4 v0, 0x0

    iput-object v0, p0, Lkik/android/widget/dk;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
...
.method public final b(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    .prologue
    .line 62
    iget-object v0, p0, Lkik/android/widget/dk;->g:Lkik/android/widget/bm;
    ...
    invoke-interface {v0, v1, v2}, Lkik/android/widget/bm;->c(II)V
