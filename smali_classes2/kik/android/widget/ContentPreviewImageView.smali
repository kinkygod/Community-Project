...
.method static synthetic a(Lkik/android/widget/ContentPreviewImageView;Landroid/graphics/Bitmap;)V
    ...
    .line 52
    :cond_0
    instance-of v2, v0, Lkik/android/widget/bd;

    if-eqz v2, :cond_2

    .line 53
    check-cast v0, Lkik/android/widget/bd;

    .line 55
    invoke-virtual {v0}, Lkik/android/widget/bd;->b()Landroid/graphics/Bitmap;
    ...
    invoke-direct {v1, p1}, Lkik/android/widget/bd;-><init>(Landroid/graphics/Bitmap;)V

    .line 68
    invoke-virtual {v1}, Lkik/android/widget/bd;->a()V

    .line 69
    invoke-virtual {v1, p0}, Lkik/android/widget/bd;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 70
    invoke-virtual {v1, v0, p1}, Lkik/android/widget/bd;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static a(Lkik/android/widget/ContentPreviewImageView;Lrx/d;)V
    ...
    invoke-static {p0}, Lkik/android/widget/ai;->a(Lkik/android/widget/ContentPreviewImageView;)Lrx/functions/b;

    move-result-object v1

    const/4 v2, 0x0

    invoke-static {p0}, Lkik/android/widget/aj;->a(Lkik/android/widget/ContentPreviewImageView;)Ljava/lang/Runnable;
...
.method public static b(Lkik/android/widget/ContentPreviewImageView;Lrx/d;)V
    ...
    invoke-static {p0}, Lkik/android/widget/ak;->a(Lkik/android/widget/ContentPreviewImageView;)Lrx/functions/b;

    move-result-object v1

    const/4 v2, 0x0

    invoke-static {p0}, Lkik/android/widget/al;->a(Lkik/android/widget/ContentPreviewImageView;)Ljava/lang/Runnable;
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1}, Lkik/android/widget/am;->a(Landroid/graphics/drawable/Animatable;)Ljava/lang/Runnable;
