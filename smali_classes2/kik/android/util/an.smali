...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkik/android/util/an;->a:Landroid/animation/ArgbEvaluator;
...
.method public static a(Landroid/view/View;FJ)V
    ...
    new-instance v3, Lkik/android/util/an$2;

    invoke-direct {v3, p0}, Lkik/android/util/an$2;-><init>(Landroid/view/View;)V
    ...
    invoke-static/range {v0 .. v5}, Lkik/android/util/an;->a(Landroid/view/View;FFLandroid/animation/AnimatorListenerAdapter;J)V
...
.method public static a(Landroid/view/View;I)V
    ...
    invoke-static {p0, p1, v0}, Lkik/android/util/an;->a(Landroid/view/View;ILandroid/animation/Animator$AnimatorListener;)V
...
.method public static a(Landroid/view/View;ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lkik/android/util/an;->a(Landroid/view/View;ILandroid/view/animation/Animation$AnimationListener;I)V
...
.method private static a(Landroid/view/View;ILandroid/view/animation/Animation$AnimationListener;I)V
    ...
    .line 419
    new-instance v1, Lkik/android/util/an$6;

    invoke-direct {v1, p2, p0, p3}, Lkik/android/util/an$6;-><init>(Landroid/view/animation/Animation$AnimationListener;Landroid/view/View;I)V
...
.method public static a(Landroid/view/View;Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-static {p0, v0, p1, v1}, Lkik/android/util/an;->a(Landroid/view/View;ILandroid/view/animation/Animation$AnimationListener;I)V
...
.method public static a(Landroid/view/View;Z)V
    ...
    invoke-static {p0, v1, v0}, Lkik/android/util/an;->a(Landroid/view/View;ILandroid/animation/Animator$AnimatorListener;)V

    goto :goto_0

    .line 287
    :cond_3
    invoke-static {p0, v1}, Lkik/android/util/an;->b(Landroid/view/View;I)V
...
.method public static b(Landroid/view/View;)V
    ...
    .line 156
    new-instance v2, Lkik/android/util/an$1;

    invoke-direct {v2, p0, v0}, Lkik/android/util/an$1;-><init>(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public static b(Landroid/view/View;FJ)V
    ...
    new-instance v3, Lkik/android/util/an$3;

    invoke-direct {v3, p0}, Lkik/android/util/an$3;-><init>(Landroid/view/View;)V
...
.method public static b(Landroid/view/View;I)V
    ...
    .line 378
    new-instance v1, Lkik/android/util/an$5;

    invoke-direct {v1, p0}, Lkik/android/util/an$5;-><init>(Landroid/view/View;)V
...
.method public static varargs b([Landroid/view/View;)V
    ...
    .line 353
    new-instance v1, Lkik/android/util/an$4;

    invoke-direct {v1, p0}, Lkik/android/util/an$4;-><init>([Landroid/view/View;)V
...
.method public static c(Landroid/view/View;)V
    ...
    invoke-static {p0, v0, v1}, Lkik/android/util/an;->a(Landroid/view/View;ILandroid/animation/Animator$AnimatorListener;)V
...
.method public static d(Landroid/view/View;)V
    ...
    invoke-static {p0, v0}, Lkik/android/util/an;->b(Landroid/view/View;I)V
