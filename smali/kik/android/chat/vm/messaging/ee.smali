.class public Lkik/android/chat/vm/messaging/ee;
.super Lkik/android/chat/vm/messaging/ct;
.source "SourceFile"

# interfaces
.implements Lkik/android/chat/vm/messaging/eo;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/ee;Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    iget-object v1, p0, Lkik/android/chat/vm/messaging/ee;->o:Landroid/content/res/Resources;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/ee;)Lrx/d;
    .locals 2
    ...
    invoke-direct {p0, v0, v1}, Lkik/android/chat/vm/messaging/ee;->a(Lkik/core/datatypes/messageExtensions/ContentMessage$ContentLinkFileType;Lkik/android/gifs/api/GifResponseData$MediaType;)Lrx/d;
...
.method private a(Lkik/core/datatypes/messageExtensions/ContentMessage$ContentLinkFileType;Lkik/android/gifs/api/GifResponseData$MediaType;)Lrx/d;
    ...
    .prologue
    .line 77
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ee;->k()Lkik/core/datatypes/messageExtensions/ContentMessage;
    ...
    .line 81
    iget-object v1, p0, Lkik/android/chat/vm/messaging/ee;->g:Lkik/android/gifs/c;
...
.method static synthetic p()Lrx/d;
    .locals 1
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/aw;)V
    ...
    .line 64
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lkik/android/chat/vm/messaging/ee;)V
...
.method public final g()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/ef;->a(Lkik/android/chat/vm/messaging/ee;)Lrx/functions/g;
    ...
    .line 110
    invoke-direct {p0, v1, v2}, Lkik/android/chat/vm/messaging/ee;->a(Lkik/core/datatypes/messageExtensions/ContentMessage$ContentLinkFileType;Lkik/android/gifs/api/GifResponseData$MediaType;)Lrx/d;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/vm/messaging/eg;->a(Lkik/android/chat/vm/messaging/ee;)Lrx/functions/g;
    ...
    invoke-static {}, Lkik/android/chat/vm/messaging/eh;->a()Lrx/functions/b;
    ...
    invoke-static {}, Lkik/android/chat/vm/messaging/ei;->a()Lrx/functions/g;
...
.method public final n()V
    ...
    .line 159
    :goto_1
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ee;->B_()Lkik/android/chat/vm/aw;

    move-result-object v2

    invoke-interface {v2, v0}, Lkik/android/chat/vm/aw;->a(Lkik/android/chat/vm/aq;)Lrx/d;

    .line 161
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ee;->f:Lcom/kik/android/Mixpanel;
    ...
    .line 154
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ee;->x()Lkik/core/datatypes/Message;
    ...
    .line 155
    invoke-static {v1}, Lkik/android/chat/vm/messaging/ee;->d(Ljava/lang/String;)Z
